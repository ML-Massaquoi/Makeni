...
class ReaderTypography {
  static TextStyle styleFor(
    ...
    switch (type) {
      case ContentBlockType.title:
        return base(size: 24, weight: FontWeight.bold, height: 1.3, spacing: -0.2);
      case ContentBlockType.sectionHeading:
        return base(size: 18, weight: FontWeight.w700, height: 1.4, color: accentColor, spacing: 0.5);
      case ContentBlockType.subsectionHeading:
        return base(size: 16, weight: FontWeight.w600, height: 1.4, color: accentColor, spacing: 0.3);
      case ContentBlockType.prayer:
        return base(size: 18, weight: FontWeight.normal, height: 1.8, spacing: 0.3);
      case ContentBlockType.prayerBody:
        return base(size: 18, weight: FontWeight.normal, height: 1.8, spacing: 0.3);
      case ContentBlockType.priestText:
        return base(size: 17, weight: FontWeight.w500, height: 1.7, color: accentColor.withValues(alpha: 0.85), spacing: 0.3);
      case ContentBlockType.congregationResponse:
        return base(size: 17, weight: FontWeight.w600, height: 1.7, spacing: 0.3, style: FontStyle.italic);
      case ContentBlockType.rubric:
        return base(size: 14, weight: FontWeight.normal, height: 1.5, color: secondaryColor, style: FontStyle.italic);
      case ContentBlockType.instruction:
        return base(size: 15, weight: FontWeight.w500, height: 1.6, color: accentColor, spacing: 0.5);
      case ContentBlockType.bibleQuote:
        return base(size: 17, weight: FontWeight.normal, height: 1.8, color: baseColor, spacing: 0.3, style: FontStyle.italic);
      case ContentBlockType.hymn:
        return base(size: 16, weight: FontWeight.normal, height: 1.6, spacing: 0.2);
      case ContentBlockType.note:
        return base(size: 14, weight: FontWeight.normal, height: 1.5, color: secondaryColor);
      case ContentBlockType.divider:
        return base(size: 20, weight: FontWeight.normal, height: 1, color: secondaryColor);
      case ContentBlockType.verse:
        return base(size: 16, weight: FontWeight.normal, height: 1.6, spacing: 0.2);
      case ContentBlockType.paragraph:
        return base(size: 18, weight: FontWeight.normal, height: 1.7, spacing: 0.2);
  ...
  static EdgeInsets paddingFor(ContentBlockType type) {
    switch (type) {
      ...
      case ContentBlockType.subsectionHeading:
        return const EdgeInsets.only(top: 24, bottom: 8);
      case ContentBlockType.divider:
        return const EdgeInsets.symmetric(vertical: 16);
      case ContentBlockType.priestText:
        return const EdgeInsets.only(left: 16, top: 8, bottom: 8);
      case ContentBlockType.congregationResponse:
        return const EdgeInsets.only(left: 16, top: 8, bottom: 8);
      case ContentBlockType.rubric:
